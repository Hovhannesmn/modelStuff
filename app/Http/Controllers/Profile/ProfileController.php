...
class ProfileController extends Controller
{
    ...
    public function checkSteps(){
        ...
        if($register_step > 0){
            if($register_step == 1){
                if(GlobalRequest::is('profile/create')){
                    return null;
                }else{
            ...
            if($register_step == 2){
                return redirect('profile/'.$profile->id.'/services');
            }
            if($register_step == 3){
                return redirect('profile/'.$profile->id.'/schedule');
            }
            if($register_step == 4){
                return redirect('profile/'.$profile->id.'/gallery');
            }
        }
