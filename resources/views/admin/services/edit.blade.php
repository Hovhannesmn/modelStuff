...
@section('page-title')
	<span>{{ Languages::trans('admin.services.edit_service') }}</span>
@endsection
...
@section('breadcrumbs')
  ...
  <li class="active">{{ Languages::trans('admin.services.edit_service') }}</li>
@endsection
...
@section('content')
	...
	{!! Form::open(['method'=>'PUT', 'route'=>['admin.services.update', $service->id], 'class'=>'form-horizontal']) !!}

		<div class="panel panel-default">
		
			<div class="panel-heading">
				<h4 class="panel-title">{{ Languages::trans('admin.services.edit_service') }} :</h4>
			</div>
			...
			<div class="panel-body">
				...
				<div class="form-group">
					...
					<div class="col-sm-6 mb15">
						{!! Form::text('slug', $service->slug , ['class'=>'form-control']) !!}
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<div class="input-group mb15">
							...
							{!! Form::text('name['.Languages::general().']', $service->printName(Languages::general()), ['class'=>'form-control']) !!}
						...
						<div class="panel panel-default-alt">
							...
							<div class="panel-body">
								...
								<div class="input-group input-group-sm mb15">
									...
									{!! Form::text('name['.$lang.']', $service->printName($lang) , ['class'=>'form-control']) !!}
								</div>
