...
@section('content')
	...
	<ul class="filemanager-options">
	    ...
	    <li class="filter-type">
	      <a href="{{ route('admin.galleries.create') }}"><i class="fa fa-plus"></i>&nbsp;&nbsp;&nbsp;{{ Languages::trans('general.buttons.add') }}</a>
	    </li>
	</ul>
        ...
        @foreach( $sliders as $slider )
          <tr class="slider-row">
            ...
            <td class="table-action">
              <a href="{{ route('admin.galleries.edit', $slider->id) }}"><i class="fa fa-pencil"></i></a>
    ...
    jQuery(document).ready(function($){
      ...
      var deleteItems = function(checked){
        ...
        if(id.length > 0){
          $.ajax({
            method: 'DELETE',
            url: '{!! route("admin.galleries.index") !!}/' + id.join('-'),
