          ...
          <div class="tab-content">
            <div class="tab-pane active" id="info">
              <div class="clearfix mb15">
                  <a href="/{{Auth::user()->roles[0]->name}}/profile/{{ $profile->id }}/edit" class="btn btn-white pull-right"><i class="fa fa-info-circle"></i>&nbsp;&nbsp;&nbsp;{{ Languages::trans('model.profile.edit_profile') }}</a>
              </div>
              <div class="well">
            ...
            <div class="tab-pane" id="services">
              <div class="clearfix mb15">
                  <a href="/{{Auth::user()->roles[0]->name}}/profile/{{ $profile->id }}/services" class="btn btn-white pull-right"><i class="fa fa-cubes"></i>&nbsp;&nbsp;&nbsp;{{ Languages::trans('model.profile.edit_services') }}</a>
              </div>
              <div class="well">
            ...
            <div class="tab-pane" id="schedule">
              <div class="clearfix mb15">
                  <a href="/{{Auth::user()->roles[0]->name}}/profile/{{ $profile->id }}/schedule" class="btn btn-white pull-right"><i class="fa fa-calendar"></i>&nbsp;&nbsp;&nbsp;{{ Languages::trans('model.profile.edit_schedule') }}</a>
              </div>
              <div class="well">
