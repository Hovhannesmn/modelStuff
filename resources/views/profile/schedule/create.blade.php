...
@section('breadcrumbs')
	...
	<li class="active">{{ Languages::trans('general.buttons.add') }}</li>
@endsection
...
@section('content')
	...
	{!! Form::open(['method'=>'POST', 'url'=> url('profile/' . $profile_id . '/schedule') , 'class'=>'form-horizontal']) !!}

		{!! Form::input('hidden','business_hours', null , ['class'=>'form-control']) !!}

		<div class="panel panel-default">
		
			<div class="panel-heading">
				<h4 class="panel-title">{{ Languages::trans('model.profile.add_dates_range') }} :</h4>
			</div>
							...
							<div class="row">
								<div class="col-sm-6">
									...
									<div class="input-group mb15">
										{!! Form::text('date_from', null , ['class'=>'form-control datepicker-from', 'placeholder'=>'dd/mm/yy' ]) !!}
								...
								<div class="col-sm-6">
									...
									<div class="input-group mb15">
										{!! Form::text('date_to', null , ['class'=>'form-control datepicker-to', 'placeholder'=>'dd/mm/yy' ]) !!}
										<span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
									</div>
								</div>
							</div>
