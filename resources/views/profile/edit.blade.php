    ...
    <div class="row">
      ...
      {!! Form::open(['method'=>'POST', 'url'=>url( Auth::user()->roles[0]->name .'/profile/'.$profile->id.'/update'), 'class'=>'form-horizontal']) !!}
            ...
            <div class="panel-body">
                ...
                <div class="langarea" data-locale="{{ Languages::locale() }}">
                  <div class="lapanel clearfix">
                    {{--{{(Languages::trans('model.profile.about'))}}--}}
                    <label class="pull-left" style="line-height: 30px;">{{ Languages::trans('model.profile.about') }} (short):</label>
                    <div class="btn-group pull-right">
                  ...
                  <div class="editor" style="height: 45px;"></div>
                  @foreach(Languages::all() as $lang)

                    {!! Form::input('hidden', 'about_short['.$lang.']', Languages::fromArrayOrNull($profile->about_short, $lang), ['class'=>'form-control wysiwyg '.$lang, 'data-lang'=>$lang, 'rows'=>5]) !!}
                ...
                <div class="langarea" data-locale="{{ Languages::locale() }}">
                  <div class="lapanel clearfix">
                    <label class="pull-left" style="line-height: 30px;">{{ Languages::trans('model.profile.about') }} (full):</label>
                    <div class="btn-group pull-right">
                        @foreach(Languages::all() as $lang)
                          <a class="btn btn-xs btn-white" href="#" data-lang="{{ $lang }}">{{ $lang }}</a>
                        @endforeach
        ...
        <div class="col-sm-9 col-sm-offset-3">
          <div class="panel panel-default">
            <div class="panel-heading">
              <h4 class="panel-title">{{ Languages::trans('model.profile.model_info') }}:</h4>
            </div>
            <div class="panel-body">
              <div class="form-group mb15">
                {!! Form::label('nationality', Languages::trans('model.profile.nationality').':', ['class'=>'col-sm-3 control-label']) !!}
                <div class="col-sm-6">
                  {!! Form::select('nationality', $profile->availableNationality(), $profile->nationality, ['class'=>'form-control chosen-select']) !!}
                </div>
              </div>
